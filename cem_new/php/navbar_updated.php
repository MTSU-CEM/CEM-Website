...
echo " <a class=\"dropdown-item\" href=\"$site_root/professional_dev.php\">About</a>";
echo " <a class=\"dropdown-item\" href=\"$site_root/online_professional_dev.php\">Online Professional Development</a>";
echo " <a class=\"dropdown-item\" href=\"$site_root/offline_professional_dev.php\">Offline Professional Development</a>";
echo " </div>";
